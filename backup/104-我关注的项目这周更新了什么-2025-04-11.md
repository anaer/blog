...
# 3. [clash-verge-rev v2.2.3](https://github.com/clash-verge-rev/clash-verge-rev/releases/tag/v2.2.3)  
...
# 4. [subs-check v2.1.3](https://github.com/beck-8/subs-check/releases/tag/v2.1.3)  
...
# 8. [new-api v0.6.0.14](https://github.com/QuantumNous/new-api/releases/tag/v0.6.0.14)  
AI模型接口管理与分发系统，支持将多种大模型转为统一格式调用，支持OpenAI、Claude等格式，可供个人或者企业内部管理与分发渠道使用，本项目基于One API二次开发。🍥 The next-generation LLM gateway and AI asset management system supports multiple languages.
<details>
<summary>变更说明</summary>

## What's Changed
* Update: Gemini channel fetch_models by @lamcodes in https://github.com/QuantumNous/new-api/pull/944


**Full Changelog**: https://github.com/QuantumNous/new-api/compare/v0.6.0.13...v0.6.0.14  
...
# 10. [readest v0.9.32](https://github.com/readest/readest/releases/tag/v0.9.32)  
...
# 11. [deepchat v0.0.13](https://github.com/ThinkInAIXYZ/deepchat/releases/tag/v0.0.13)  
