...
# 2. [new-api v0.6.0.9](https://github.com/Calcium-Ion/new-api/releases/tag/v0.6.0.9)  
AI模型接口管理与分发系统，支持将多种大模型转为统一格式调用，支持OpenAI、Claude等格式，可供个人或者企业内部管理与分发渠道使用，本项目基于One API二次开发。🍥 The next-generation LLM gateway and AI asset management system supports multiple languages.
<details>
<summary>变更说明</summary>

fix: Improve setup check logic

**Full Changelog**: https://github.com/Calcium-Ion/new-api/compare/v0.6.0.8...v0.6.0.9  
...
Release created at  Fri Apr  4 21:12:42 CST 2025
...
# 4. [subs-check v2.1.0-beta.2](https://github.com/beck-8/subs-check/releases/tag/v2.1.0-beta.2)  
订阅转换合并，节点可用性，测速，重命名，导出为clash.meta/clash/base64/qx等等所有格式的订阅工具
<details>
<summary>变更说明</summary>

## Changelog
* ac6393aad1be0d1ac4a34eea41f819d8e5c6b369 feat: 添加节点前缀配置

  

</details>

# 5. [readest v0.9.29](https://github.com/readest/readest/releases/tag/v0.9.29)  
...
# 6. [cherry-studio v1.1.18](https://github.com/CherryHQ/cherry-studio/releases/tag/v1.1.18)  
...
# 7. [higress v2.1.0](https://github.com/alibaba/higress/releases/tag/v2.1.0)  
...
# 9. [Ghosten-Player v1.7.1](https://github.com/GhostenEditor/Ghosten-Player/releases/tag/v1.7.1)  
...
# 10. [deepchat v0.0.12](https://github.com/ThinkInAIXYZ/deepchat/releases/tag/v0.0.12)  
