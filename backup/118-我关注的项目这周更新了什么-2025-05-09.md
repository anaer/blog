...
# 1. [readest v0.9.40](https://github.com/readest/readest/releases/tag/v0.9.40)  
...
## What's Changed
* doc: format issue templates  
* fix: dialog drag handler layout, closes   
* fix: segment separator now should be more than 8 dash, closes   
* fix: avoid glitches when expanding toc subitems, closes   
* fix: styling links and also the content of links, closes   
* fix: revert to unlock screen orientation for library page, closes   
* fix: transient navigation bar in Android 9, closes   
* fix: close action bar when the footbar is dismissed, closes   
* compat: fix insane img dimension might cause layout miscalculation, closes   
* revert: unbreak style overriding, closes  and closes   
...
# 2. [TVBoxOSC 20250508-0056](https://github.com/o0HalfLife0o/TVBoxOSC/releases/tag/20250508-0056)  
...
# 3. [new-api v0.7.0-alpha.4](https://github.com/QuantumNous/new-api/releases/tag/v0.7.0-alpha.4)  
...
# 4. [fit-framework v3.5.0-M2](https://github.com/ModelEngine-Group/fit-framework/releases/tag/v3.5.0-M2)  
...
# 5. [ublacklist v8.11.0](https://github.com/iorate/ublacklist/releases/tag/v8.11.0)  
...
# 6. [anx-reader beta-1.4.5-5](https://github.com/Anxcye/anx-reader/releases/tag/beta-1.4.5-5)  
...
# 8. [Ghosten-Player v2.0.2](https://github.com/GhostenEditor/Ghosten-Player/releases/tag/v2.0.2)  
