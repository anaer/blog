...
document.addEventListener("DOMContentLoaded", function() {
    createTOC();
    var css = '.toc {position:fixed;top:130px;left:50%;transform: translateX(50%) translateX(300px);width:250px;padding-left:30px;}@media (max-width: 1249px) {.toc{position:static;top:auto;left:auto;transform:none;padding:10px;margin-bottom:20px;background-color:#eee;}}';
