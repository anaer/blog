function createVercount() {
    ...
    if (postPublish){
        postPublish.insertAdjacentHTML('beforebegin','<div id="vercount_container_page_pv" style="display:none;float:left;margin-top:3px;margin-right:5px;font-size:small;">👁<span id="vercount_value_page_pv"></span></div>');
    }
